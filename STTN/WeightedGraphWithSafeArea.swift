import SwiftGraph
open class WeightedGraphWithSafeArea<V: Equatable & Codable, W: Equatable & Codable>: Graph {
    
    public var vertices: [V] = [V]()
    public var edges: [[WeightedEdgeWithSafeArea<W>]] = [[WeightedEdgeWithSafeArea<W>]]() //adjacency lists
    ...
    ///                       Default is false.
    public func addEdge(_ e: WeightedEdgeWithSafeArea<W>, directed: Bool) {
        edges[e.u].append(e)
        if !directed && e.u != e.v {
