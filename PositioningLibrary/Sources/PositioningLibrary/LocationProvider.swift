...
public class LocationProvider: NSObject, ARSessionDelegate {
    ...
    public var originFixed = false // true if AR Origin==Floor Origin
    
    public var fixPosition : Bool = false
    public var alpha : Float = 0.0
    public var x_t : Float = 0.0
    public var y_t : Float = 0.0
    public var rotationMatrix : simd_float4x4 = matrix_identity_float4x4
    public var translationMatrix : simd_float4x4 = matrix_identity_float4x4
    public var newWorldTransform : simd_float4x4 = matrix_identity_float4x4
...
//    }
    ...
    private func fixAROrigin(imageAnchor: ARImageAnchor, location: Location) {
        ...
        newWorldTransform = simd_mul(rotationMatrix, translationMatrix)
